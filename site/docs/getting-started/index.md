...
1. Install .NET 10 and add the package.
2. Build the first app with the quick start.
3. Learn the app model and layout model.
4. Apply a built-in theme and control overrides.
5. Walk through an example app.
