...
Extended family-by-family matrix lives in [public-api-inventory](/docs/public-api-inventory).
...
- starter theming docs stay focused on primary `Tessera` authoring namespaces
