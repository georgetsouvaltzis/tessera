...
`RoundedSurfaceMode = ButtonRoundedSurfaceMode.UnifiedShell` is the filled-pill mode and should reserve enough vertical space for visible rounded caps instead of collapsing into a 3-row cutout.
