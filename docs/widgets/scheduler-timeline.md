...
sidebar_label: "SchedulerTimeline"
---
...
| `ConflictRowStyle` | `TesseraStyle` |
| `DisabledStyle` | `TesseraStyle` |
| `EmptyText` | `string` |
| `EmptyTextStyle` | `TesseraStyle` |
| `EntryTextStyle` | `TesseraStyle` |
...
| Event | Type |
| --- | --- |
| `SelectionChanged` | `EventHandler<SchedulerSelectionChangedEventArgs>?` |
