...
Use `AreaPlot` when this interaction is the best match for your screen workflow.

## When to use

- You need a `AreaPlot`-style interaction inside the dashboards & plots lane.
...
- Do not choose `AreaPlot` by name only; validate it against the target workflow.
