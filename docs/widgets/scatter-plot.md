...
Use `ScatterPlot` when this interaction is the best match for your screen workflow.

## When to use

- You need a `ScatterPlot`-style interaction inside the dashboards & plots lane.
...
- Do not choose `ScatterPlot` by name only; validate it against the target workflow.
