...
- item `3`: **In progress** (consumer ergonomics helpers now include dialog/result, table row mutation, header row composition, theme override bundles, and auto-rescheduling periodic effects via `184e3ae`, `ff557e6`, `9cf07b2`, `d067b1d`, `07ae666`; broader API-surface consistency still open)
