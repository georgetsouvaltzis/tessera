...
//                 AppendLog(_lastEvent);
//                 return NextTickCommand(_stressMode);
//             }
//
//             if (IsWorkspacePage)
//             {
...
internal sealed class CounterModel : IModel
{
    ...
    public Command? Update(IMessage message)
    {
        if (message is KeyPressMsg key)
        {
            ...
            else if (key.Is(KeyCode.Down, KeyModifiers.None))
            {
                _count--;
            }
    ...
    // inside CounterModel
    private readonly TeaStyle _title = TeaStyle.Empty
        .WithBold()
        .WithForeground(AnsiColor.Rgb(137, 180, 250)); // Catppuccin blue

    private readonly TeaStyle _countStyle = TeaStyle.Empty
        .WithBold()
        .WithForeground(AnsiColor.Rgb(249, 226, 175)); // Catppuccin yellow
    ...
    public ModelView View()
    {
        ...
        var help = _help.Render("Up/Down: change  q: quit");
