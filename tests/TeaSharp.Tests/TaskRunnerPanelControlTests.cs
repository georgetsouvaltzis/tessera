...
public sealed class TaskRunnerPanelControlTests
{
    ...
    {
        var hoveredStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(18, 52, 86));
        var control = new TaskRunnerPanel
        {
            Border = BorderStyle.None,
            ShowTimestamp = false,
    ...
    {
        var focusedBorderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(120, 90, 40));
        var control = new TaskRunnerPanel
        {
            IsFocused = true,
            Border = BorderStyle.SingleLine,
            ShowTimestamp = false,
            BorderStyleText = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(10, 11, 12)),
            FocusedBorderStyleText = focusedBorderStyle,
            RunningStatusStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(30, 40, 50)),
            SelectedRowStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(60, 70, 80)),
        };
