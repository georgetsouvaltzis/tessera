...
public sealed class SearchResultsViewControlTests
{
    ...
    public void Controls_SearchResultsView_DisabledPointerInput_DoesNotHoverOrSelect()
    {
        var control = new SearchResultsView
        {
            Border = BorderStyle.None,
            IsDisabled = true,
            HoveredRowStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(91, 92, 93)),
        };
    ...
    public void Controls_SearchResultsView_StateStyles_ApplyFocusedHoveredPressedAndError()
    {
        var control = new SearchResultsView
        {
            ...
            IsFocused = true,
            HasError = true,
            DefaultRowStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(1, 2, 3)),
            HoveredRowStyle = TeaStyle.Empty.WithBold(),
            SelectedRowStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(21, 22, 23)),
            FocusedSelectedRowStyle = TeaStyle.Empty.WithItalic(),
            PressedRowStyle = TeaStyle.Empty.WithUnderline(),
            ErrorRowStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(31, 32, 33)),
        };
    ...
    public void Theme_SearchResultsView_ApplyAndDefaults_MapExpectedTokens_AndPreserveExplicitStyles()
    {
        var theme = new TeaTheme
        {
            ...
            {
                Foreground = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(14, 15, 16)),
                Background = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(17, 18, 19)),
            },
            Focus = new TeaThemeFocusTokens
            {
                Ring = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(20, 21, 22)),
                Title = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(23, 24, 25)),
                Border = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(26, 27, 28)),
            },
            Border = new TeaThemeBorderTokens
            {
                Default = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(29, 30, 31)),
                Focused = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(32, 33, 34)),
            },
            State = new TeaThemeStateTokens
            {
                Error = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(35, 36, 37)),
            },
        };
