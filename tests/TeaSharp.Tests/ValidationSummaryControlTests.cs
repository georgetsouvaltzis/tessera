...
internal static class ValidationSummaryControlTests
{
    ...
    {
        var hoveredStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(61, 92, 123));
        var summary = new ValidationSummary
        {
    ...
    private static Task RenderStylesAndSeverity_Deterministic()
    {
        var summary = new ValidationSummary
        {
            Border = BorderStyle.None,
            IsFocused = true,
            DefaultIssueStyle = TeaStyle.Empty.WithItalic(),
            HoveredIssueStyle = TeaStyle.Empty.WithOverline(),
            SelectedIssueStyle = TeaStyle.Empty.WithBold(),
            FocusedIssueStyle = TeaStyle.Empty.WithUnderline(),
            DisabledIssueStyle = TeaStyle.Empty.WithDim(),
            InfoSeverityStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(10, 11, 12)),
            WarningSeverityStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(20, 21, 22)),
            ErrorSeverityStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(30, 31, 32)),
        };
        summary.SetIssues(
        [
