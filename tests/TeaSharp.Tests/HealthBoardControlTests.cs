...
public sealed class HealthBoardControlTests
{
    ...
    public void Controls_HealthBoard_StyleAndGlyphHooks_RenderExpectedAnsiAndCustomMarkers()
    {
        var control = new HealthBoard
        {
            ...
            DegradedServiceStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(100, 110, 120)),
            OutageServiceStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(130, 140, 150)),
            SelectedServiceStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(160, 170, 180)),
        };
