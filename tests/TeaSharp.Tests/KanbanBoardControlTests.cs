...
public sealed class KanbanBoardControlTests
{
    ...
    public void Controls_KanbanBoard_PointerHoverAndStateStyles_RenderExpectedAnsi()
    {
        ...
        var control = new KanbanBoard
        {
            ...
            SelectedCardStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(1, 2, 3)),
            FocusedCardStyle = TeaStyle.Empty.WithItalic(),
            HoveredCardStyle = TeaStyle.Empty.WithUnderline(),
            DisabledCardStyle = TeaStyle.Empty.WithDim(),
            ErrorCardStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(90, 91, 92)),
        };
