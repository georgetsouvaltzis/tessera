...
internal static partial class ThemeOverridesTests
{
    ...
    private static Task ApplyHelpers_MapExpectedTokens_ForWave3DevOpsControls()
    {
        var theme = new TeaTheme
        {
            ...
            State = new TeaThemeStateTokens
            {
                ...
                Success = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(94, 95, 96)),
                Warning = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(97, 98, 99)),
    ...
    private static Task ApplyThemeDefaults_DoNotOverwriteExplicitStyles_ForWave3DevOpsControls()
    {
        ...
        var theme = new TeaTheme
        {
            ...
            State = new TeaThemeStateTokens
            {
                Info = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(38, 39, 40)),
                Success = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(41, 42, 43)),
                Warning = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(44, 45, 46)),
                Error = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(47, 48, 49)),
            },
        };
    ...
    private static Task OverrideOverloads_ResolveExpectedTokens_ForWave3DevOpsControls()
    {
        ...
        var typeTheme = new TeaTheme
        {
            ...
            State = new TeaThemeStateTokens
            {
                ...
                Success = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(184, 185, 186)),
                Warning = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(187, 188, 189)),
                Error = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(190, 191, 192)),
            },
        };
