...
public sealed class DashboardGridControlTests
{
    ...
    public void Controls_DashboardGrid_StyleHooks_EmitAnsiAndFocusMarker()
    {
        var control = new DashboardGrid
        {
            ...
            FocusedBorderStyleText = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(30, 40, 50)),
            TitleStyleText = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(40, 50, 60)),
            FocusedTitleStyleText = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(60, 70, 80)),
            SelectedTileStyleText = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(80, 90, 100)),
        };
        control.SetTiles(
        [
