...
public sealed class ThemeFocusMarkerParityPolicyTests
{
    ...
    {
        var extensionMethods = typeof(TeaThemeControlExtensions).GetMethods(BindingFlags.Public | BindingFlags.Static);
        ...
        for (var index = 0; index < PolicyControlTypes.Length; index++)
        {
            ...
            var applyTheme = FindExtensionMethod(extensionMethods, nameof(TeaThemeControlExtensions.ApplyTheme), controlType);
            var applyThemeDefaults = FindExtensionMethod(extensionMethods, nameof(TeaThemeControlExtensions.ApplyThemeDefaults), controlType);
