...
public sealed class RichTextViewControlTests
{
    ...
    public void RichTextView_RendersHeadingsListMarkersQuotesAndInlineEmphasis()
    {
        ...
        [
            ...
            [RichTextSegment.ListMarker("-"), RichTextSegment.Plain("Install "), RichTextSegment.Emphasis("TeaSharp"), RichTextSegment.Plain(" package")],
        ...
        TestAssert.True(output.Contains("- Install TeaSharp package", StringComparison.Ordinal), "List marker and inline emphasis content should render in-order.");
    ...
    public void RichTextView_StyleHooks_EmitAnsiForSemanticKinds()
    {
        ...
        {
            Border = BorderStyle.None,
            TextStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(1, 2, 3)),
            HeadingStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(11, 12, 13)),
            ListMarkerStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(21, 22, 23)),
            QuoteMarkerStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(31, 32, 33)),
            EmphasisStyle = TeaStyle.Empty.WithItalic(),
            StrongStyle = TeaStyle.Empty.WithUnderline(),
            InlineCodeStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(41, 42, 43)),
        };
        control.SetLines(
        [
