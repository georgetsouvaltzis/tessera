...
[TestFixture]
public sealed class TeaSceneCompilerPointerVisibilityTests
{
    [Test]
    public void TeaSceneCompiler_HiddenDialogOverlay_DoesNotInterceptPointerPress()
    {
    ...
    [Test]
    public void TeaSceneCompiler_VisibleDialogOverlay_ContinuesToInterceptPointerPress()
    {
    ...
    private sealed class OverlayPointerProbeApp : TeaApp
    {
