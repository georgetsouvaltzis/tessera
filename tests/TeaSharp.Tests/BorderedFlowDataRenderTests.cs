...
internal static class BorderedFlowDataRenderTests
{
    ...
    private static Task Dialog_FocusedBorderStyleText_StylesFrameGlyphs()
    {
        ...
        var borderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(12, 24, 36));
    ...
    {
        var focusedBorderStyle = TeaStyle.Empty.WithBold();
        var borderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(44, 55, 66));
        var modal = new Modal
        {
            IsVisible = true,
            IsFocused = true,
    ...
    {
        var focusedBorderStyle = TeaStyle.Empty.WithBold();
        var borderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(77, 88, 99));
    ...
    {
        var focusedBorderStyle = TeaStyle.Empty.WithBold();
        var borderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(123, 98, 76));
