...
internal static class TeaProgramOptionsTests
{
    ...
    private static Task Defaults_MapToStableProgramDefaults()
    {
        ...
        TestAssert.True(mapped.CatchEffectExceptions, "TeaProgramOptions should catch command exceptions by default.");
    ...
    {
        static IMessage Recover(Exception exception) => new EffectErrorMsg(exception);
        ...
        TestAssert.True(!mapped.CatchEffectExceptions, "TeaProgramOptions should map command exception policy.");
        TestAssert.ReferenceSame((object)Recover, options.MapEffectException!, "TeaProgramOptions should preserve recovery delegate.");
    ...
    private sealed class NoOpModel : IScreen
    {
        ...
        public TeaSharp.Core.Abstractions.ScreenOutput Render() => TeaSharp.Core.Abstractions.ScreenOutput.From(string.Empty);
    }
}
