...
public sealed class TreeMapChartControlTests
{
    ...
    {
        var focusedBorderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(90, 80, 70));
        var peakStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(11, 22, 33));
        ...
        var control = new TreeMapChart
        {
            ...
            ShowLegend = false,
            IsFocused = true,
            BorderStyleText = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(10, 10, 10)),
