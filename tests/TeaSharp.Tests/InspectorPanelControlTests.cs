...
public sealed class InspectorPanelControlTests
{
    ...
    public void Controls_InspectorPanel_RendersSectionsAndRows()
    {
        ...
        general.AddField("Name", "TeaSharp");
        ...
        TestAssert.True(output.Contains("TeaSharp", StringComparison.Ordinal), "Field value should render.");
    ...
    public void Controls_InspectorPanel_FocusedStyles_EmitAnsi()
    {
        ...
        var borderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(111, 101, 91));
        var selectedStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(7, 17, 27));
        var control = new InspectorPanel
        {
            IsFocused = true,
