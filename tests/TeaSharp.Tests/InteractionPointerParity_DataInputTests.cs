...
internal static class InteractionPointerParityDataInputTests
{
    ...
    {
        var hoveredStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(17, 34, 51));
        var control = new MultiSelect
        {
    ...
    {
        var hoveredRowStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(10, 20, 30));
        var hoveredCellStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(40, 50, 60));
