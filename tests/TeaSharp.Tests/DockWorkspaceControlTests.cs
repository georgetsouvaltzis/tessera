...
public sealed class DockWorkspaceControlTests
{
    ...
    {
        var focusedBorder = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(120, 70, 33));
        var focusedPaneBorder = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(41, 91, 131));
        var selectedBody = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(9, 19, 29));
        var control = new DockWorkspace
        {
            IsFocused = true,
