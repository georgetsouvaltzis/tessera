...
public sealed class HeatmapControlTests
{
    ...
    {
        var highStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(11, 22, 33));
        var selectedStyle = TeaStyle.Empty.WithBackground(AnsiColor.Rgb(44, 55, 66));
        var focusedBorderStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(77, 88, 99));
        var control = new Heatmap
        {
    ...
    {
        var coldStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(10, 60, 110));
        var hotStyle = TeaStyle.Empty.WithForeground(AnsiColor.Rgb(200, 90, 30));
        var control = new Heatmap
        {
            Border = BorderStyle.None,
            ShowLegend = true,
            ShowRowLabels = false,
            ShowColumnLabels = false,
            LegendStyle = TeaStyle.Empty.WithUnderline(),
        };
        control.SetLegend(
        [
