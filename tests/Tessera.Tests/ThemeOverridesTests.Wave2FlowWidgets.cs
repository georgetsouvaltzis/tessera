...
internal static partial class ThemeOverridesTests
{
    ...
    private static Task ApplyHelpers_MapExpectedTokens_ForWave2QueryPivotRichTextControls()
    {
        var theme = new TesseraTheme
        {
            ...
            {
                Panel = TesseraStyle.Empty.WithBackground(AnsiColor.Rgb(35, 36, 37)),
            },
            Accent = new TesseraThemeAccentTokens
            {
                Primary = TesseraStyle.Empty.WithForeground(AnsiColor.Rgb(41, 42, 43)),
            ...
            State = new TesseraThemeStateTokens
            {
                Error = TesseraStyle.Empty.WithForeground(AnsiColor.Rgb(91, 92, 93)),
            },
        };
    ...
    private static Task ApplyThemeDefaults_DoNotOverwriteExplicitStyles_ForWave2QueryPivotRichTextControls()
    {
        ...
        var theme = new TesseraTheme
        {
            ...
            Surface = new TesseraThemeSurfaceTokens
            {
                Panel = TesseraStyle.Empty.WithBackground(AnsiColor.Rgb(10, 11, 12)),
            },
            Accent = new TesseraThemeAccentTokens
            {
            ...
            State = new TesseraThemeStateTokens
            {
                Error = TesseraStyle.Empty.WithForeground(AnsiColor.Rgb(40, 41, 42)),
            },
        };
