...
internal static class ProtocolFixtureTests
{
    ...
    {
        yield return new TestCase("ProtocolFixture_Ghostty_ModifyOtherKeys_DecodesModifiers",
            Ghostty_ModifyOtherKeys_DecodesModifiers);
        yield return new TestCase("ProtocolFixture_ITerm2_CsiU_DecodesModifierCombos",
            ITerm2_CsiU_DecodesModifierCombos);
        ...
        yield return new TestCase("ProtocolFixture_TerminalReader_FocusPasteRoundTrip",
            TerminalReader_FocusPasteRoundTrip);
        yield return new TestCase("ProtocolFixture_AppleTerminal_AltFallback_Decodes",
            AppleTerminal_AltFallback_Decodes);
    }
    ...
    private static Task Ghostty_ModifyOtherKeys_DecodesModifiers()
    {
        ...
        // Act
        var altCtrlSemicolon = Decode(decoder, "\e[27;7;59~");
        var shiftAltCtrlJ = Decode(decoder, "\e[27;8;106~");
    ...
    private static Task ITerm2_CsiU_DecodesModifierCombos()
    {
        ...
        // Act
        var ctrlShiftTab = Decode(decoder, "\e[9;6u");
        var altB = Decode(decoder, "\e[98;3u");
        var altBackspace = Decode(decoder, "\e[127;3u");
    ...
    private static Task Tmux_CsiCursorModifiers_Decode()
    {
        ...
        // Act
        var altUp = Decode(decoder, "\e[1;3A");
        var shiftCtrlLeft = Decode(decoder, "\e[1;6D");
        var ctrlRight = Decode(decoder, "\e[1;5C");
    ...
    private static Task Xterm_FunctionKeys_Decode()
    {
        ...
        // Act
        var ss3F1 = Decode(decoder, "\eOP");
        var ss3F4 = Decode(decoder, "\eOS");
        var csiF8 = Decode(decoder, "\e[19~");
        var shiftF11 = Decode(decoder, "\e[23;2~");
        var ctrlAltF12 = Decode(decoder, "\e[24;7~");
    ...
    private static Task Kitty_CsiUCombos_Decode()
    {
        ...
        // Act
        var ctrlEnter = Decode(decoder, "\e[13;5u");
        var shiftAltTab = Decode(decoder, "\e[9;4u");
        var ctrlAltBackspace = Decode(decoder, "\e[127;7u");
        var repeatCtrlK = Decode(decoder, "\e[107;5;2u");
        var releaseCtrlK = Decode(decoder, "\e[107;5:3u");
        ...
        AssertKey(repeatCtrlK, KeyCode.Character, KeyModifiers.Ctrl, "k", true);
    ...
    private static Task WezTerm_ModifyOtherKeys_Decode()
    {
        ...
        // Act
        var altSlash = Decode(decoder, "\e[27;3;47~");
        var ctrlSemicolon = Decode(decoder, "\e[27;5;59~");
        var shiftCtrlK = Decode(decoder, "\e[27;6;107~");
    ...
    private static Task Konsole_MetaCursorAndCsiU_Decode()
    {
        ...
        // Act
        var metaLeft = Decode(decoder, "\e[1;9D");
        var metaB = Decode(decoder, "\e[98;9u");
        var ctrlMetaB = Decode(decoder, "\e[98;13u");
    ...
    private static Task Urxvt1015_Mouse_Decode()
    {
        ...
        // Act
        var press = Decode(decoder, "\e[0;11;7M");
        var motion = Decode(decoder, "\e[35;11;7M");
    ...
    private static Task Alacritty_AltFallback_Decode()
    {
        ...
        // Act
        var altLeft = decoder.Decode([0x1B, 0x1B, (byte)'[', (byte)'D'], false);
        var altRight = decoder.Decode([0x1B, 0x1B, (byte)'[', (byte)'C'], false);
        var altEnter = decoder.Decode([0x1B, 0x0D], false);
    ...
    private static async Task TerminalReader_FocusPasteRoundTrip()
    {
        ...
        TestAssert.True(events[2] is PasteMsg { Content: "hello\nγειά" },
            "Third fixture event should aggregate paste payload.");
    ...
    private static Task AppleTerminal_AltFallback_Decodes()
    {
        ...
        TestAssert.True(focusIn.Message is FocusInMsg,
            "Focus-in marker should decode consistently in fallback fixtures.");
        return Task.CompletedTask;
    }

    private static DecodeResult Decode(EventDecoder decoder, string sequence)
    {
        return decoder.Decode(Encoding.UTF8.GetBytes(sequence), false);
    }
