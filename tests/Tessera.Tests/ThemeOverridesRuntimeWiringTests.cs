...
public sealed class ThemeOverridesRuntimeWiringTests
{
    ...
    public void ThemeOverridesRuntimeWiringRuntimeCreationPropagatesThemeAndOverridesToContext()
    {
        ...
        Assert.That(ReferenceEquals(theme, app.Context.Theme), Is.True, "Runtime should hydrate ScreenContext.Theme from TesseraRuntimeOptions.");
        Assert.That(ReferenceEquals(overrides, app.Context.ThemeOverrides), Is.True, "Runtime should hydrate ScreenContext.ThemeOverrides from TesseraRuntimeOptions.");
    }
    ...
    public void ThemeOverridesRuntimeWiringSceneCompilationAppliesOverrideHierarchyForFocusedState()
    {
        ...
        overrides.SetControlInstanceState(button, TesseraThemeVisualState.Focused, BuildThemeWithPrimary(AnsiColor.BrightRed));
    ...
    private static TesseraTheme BuildThemeWithPrimary(AnsiColor color)
    {
        return new TesseraTheme
        {
            ...
            {
                Primary = TesseraStyle.Empty.WithForeground(color),
            },
        };
    }
