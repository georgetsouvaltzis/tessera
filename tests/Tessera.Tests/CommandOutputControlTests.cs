...
public sealed class CommandOutputControlTests
{
    ...
    {
        var control = new CommandOutput { Border = BorderStyle.None, ShowTimestamp = false };
    ...
    {
        var control = new CommandOutput { Border = BorderStyle.None, IsFocused = true, ShowTimestamp = false };
        control.SetLines(
        [
    ...
    public void ControlsCommandOutputStateStylesEmitAnsiAndDefaultRenderDeterministic()
    {
        ...
        var styledOutput = Render(styled, 80, 4);
        ...
        var plain = new CommandOutput { Border = BorderStyle.None, ShowTimestamp = false };
