...
public sealed class KanbanBoardControlTests
{
    ...
    public void ControlsKanbanBoardRendersLanesAndSelectedCardMarker()
    {
        ...
        var control = new KanbanBoard { Title = "Ops" };
        ...
        TestAssert.True(output.Contains("Todo", StringComparison.Ordinal),
            "Kanban board should render first lane header.");
        TestAssert.True(output.Contains("Done", StringComparison.Ordinal),
            "Kanban board should render second lane header.");
    ...
    public void ControlsKanbanBoardKeyboardNavigationUpdatesSelectionAndRaisesEvent()
    {
        ...
        var control = new KanbanBoard { IsFocused = true };
    ...
    public void ControlsKanbanBoardPointerHoverAndStateStylesRenderExpectedAnsi()
    {
        ...
        lane.AddCard(new KanbanCard("B") { IsDisabled = true, HasError = true });
        ...
        TestAssert.True(output.Contains("48;2;1;2;3", StringComparison.Ordinal),
            "Selected card style should be rendered.");
        TestAssert.True(output.Contains("38;2;90;91;92", StringComparison.Ordinal),
            "Error card style should be rendered.");
        TestAssert.True(
    ...
    public void ControlsKanbanBoardDefaultRenderIsDeterministicAndMonochrome()
    {
        ...
        TestAssert.True(!first.Contains("\e[", StringComparison.Ordinal),
            "Default Kanban board should render monochrome output.");
    }
}
