...
internal static class TesseraControlCatalogTests
{
    ...
    [
        ...
        typeof(Accordion),
        typeof(Tessera.Controls.AccordionSection),
        typeof(TextInput),
        typeof(TextArea),
        typeof(Choice),
        typeof(ComboBox),
        typeof(CommandPalette),
        typeof(Tessera.Controls.CommandPaletteItem),
        typeof(Dialog),
        typeof(DataGrid),
        ...
        typeof(ContextMenu),
        typeof(Tessera.Controls.ContextMenuItem),
        typeof(LogView),
        typeof(Modal),
    ...
    private static Task RootPollingMethods_AreMarkedAdvanced()
    {
        var methods =
            new (Type Type, string Name, Type[] Parameters)[]
            {
                ...
                (typeof(Dialog), nameof(Dialog.TryConsumeResult), [typeof(Tessera.Controls.DialogResult).MakeByRefType()]),
    ...
    private static Task PromotedAdvancedControls_WorkThroughRootWrappers()
    {
        ...
        [
            new Tessera.Controls.AccordionSection("Overview", ["alpha"]),
            new Tessera.Controls.AccordionSection("Deploy", ["ship it"]),
        ]);
        accordion.MoveNext();
        ...
        menu.SetItems(
        [
            new Tessera.Controls.ContextMenuItem("copy", "Copy"),
            new Tessera.Controls.ContextMenuItem("paste", "Paste"),
        ]);
        menu.OpenAt(2, 2);
        ...
        palette.SetItems(
        [
            new Tessera.Controls.CommandPaletteItem("deploy", "Deploy", "publish release"),
            new Tessera.Controls.CommandPaletteItem("rollback", "Rollback", "restore previous"),
        ]);
        palette.Open();
