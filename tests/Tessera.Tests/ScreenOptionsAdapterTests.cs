...
internal static class ScreenOptionsAdapterTests
{
    ...
    {
        var options = new ScreenOptions { FontSpec = "Iosevka Term 14" };
    ...
    {
        var output = new TerminalOutput { FontSpec = "JetBrains Mono 13" };
    ...
    {
        var options = new ScreenOptions { FontFamily = "Iosevka Term", FontSize = 14, Iterm2Profile = "Tessera" };
        ...
        TestAssert.True(output.FontSize == 14,
            "ScreenOptionsAdapter should map ScreenOptions.FontSize to TerminalOutput.FontSize.");
        TestAssert.True(
            string.Equals(output.Iterm2Profile, "Tessera", StringComparison.Ordinal),
    ...
    {
        var output = new TerminalOutput { FontFamily = "JetBrains Mono", FontSize = 13, Iterm2Profile = "Work" };
        ...
        TestAssert.True(options.FontSize == 13,
            "ScreenOptionsAdapter should map TerminalOutput.FontSize to ScreenOptions.FontSize.");
        TestAssert.True(
    ...
    {
        var hostingProfile = new TerminalCapabilityProfile(
            true,
            true,
            true,
            true,
        ...
        TestAssert.True(!coreProfile.SupportsOsc50FontRequests,
            "Hosting profile should map SupportsOsc50FontRequests to core.");
        TestAssert.True(coreProfile.SupportsIterm2ProfileRequests,
            "Hosting profile should map SupportsIterm2ProfileRequests to core.");
        return Task.CompletedTask;
    }

    private static Task CoreCapabilityProfile_AsHosting_MapsFontFlags()
    {
        var coreProfile = new Core.Terminal.Capabilities.TerminalCapabilityProfile(
            true,
            true,
            true,
            true,
        ...
        TestAssert.True(!hostingProfile.SupportsOsc50FontRequests,
            "Core profile should map SupportsOsc50FontRequests to hosting.");
        TestAssert.True(hostingProfile.SupportsIterm2ProfileRequests,
            "Core profile should map SupportsIterm2ProfileRequests to hosting.");
        return Task.CompletedTask;
    }
}
