...
public static class TesseraHost
{
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Advanced)]
    public static TesseraApplication CreateApplication(TesseraApp app, TesseraRuntimeOptions? options = null, TesseraHostingOptions? hosting = null) =>
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Advanced)]
    public static async Task<TesseraApp> RunAsync(TesseraApp app, TesseraRuntimeOptions? options = null, TesseraHostingOptions? hosting = null, CancellationToken cancellationToken = default)
    {
