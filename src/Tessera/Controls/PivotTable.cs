...
public sealed partial class PivotTable : Control
{
    ...
    public TesseraStyle BodyStyle { get; set; } = TesseraStyle.Empty;
    ...
    public TesseraStyle FocusedCellStyle { get; set; } = TesseraStyle.Empty;
    ...
    private TesseraStyle ResolveBodyStyle(bool selected, bool focusedCell)
    {
        var style = BodyStyle;
        if (selected)
        {
    ...
    private static void WriteCell(Canvas canvas, int x, int y, string text, int width, TesseraStyle style, int maxWidth)
    {
