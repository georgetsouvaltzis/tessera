...
public sealed partial class TagInput
{
    ...
    private static void AppendSpaceElements(List<FlowInlineElement> elements, int count, TesseraStyle style)
    {
    ...
    private static void AppendTextElements(List<FlowInlineElement> elements, string text, TesseraStyle style)
    {
    ...
    private TesseraStyle ResolveInputStyle(bool placeholderVisible)
    {
    ...
    private TesseraStyle ResolveCaretStyle(TesseraStyle inputStyle)
    {
        var style = CaretStyle.IsEmpty ? inputStyle.Merge(TesseraStyle.Empty.WithInverse()) : CaretStyle;
        if (IsDisabled)
        {
            style = style.Merge(DisabledTagStyle);
        }
