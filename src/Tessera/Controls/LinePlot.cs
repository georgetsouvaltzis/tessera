...
public sealed partial class LinePlot : Control
{
    ...
    private static void DrawGrid(Canvas canvas, Rect area, TesseraStyle style)
    {
    ...
    private static void DrawHorizontalLine(Canvas canvas, int x, int y, int width, TesseraStyle style, char glyph)
    {
    ...
    private static void DrawVerticalLine(Canvas canvas, int x, int y, int height, TesseraStyle style, char glyph)
    {
        var styledGlyph = RenderGlyph(glyph, style);
    ...
    private static void WriteStyledGlyph(Canvas canvas, int x, int y, char fallbackGlyph, TesseraStyle style)
    {
    ...
    private static string? RenderGlyph(char glyph, TesseraStyle style)
    {
