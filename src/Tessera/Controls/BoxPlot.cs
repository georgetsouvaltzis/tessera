...
public sealed class BoxPlot : Control
{
    ...
    private static void WriteSpan(Canvas canvas, int y, int start, int end, char glyph, TesseraStyle style)
    {
    ...
    private static void WriteGlyph(Canvas canvas, int x, int y, char glyph, TesseraStyle style)
    {
        if (style.IsEmpty)
        {
