...
public sealed class ColumnLayout : LayoutNode
{
    ...
    {
        return Add(LayoutSlot.Auto(component, margin));
    }
    ...
    {
        return Add(LayoutSlot.Auto(control, margin));
    }
    ...
    {
        return Add(LayoutSlot.Fixed(component, size, margin));
    }
    ...
    {
        return Add(LayoutSlot.Fixed(control, size, margin));
    }
    ...
    {
        return Add(LayoutSlot.Fill(component, margin));
    }
    ...
    {
        return Add(LayoutSlot.Fill(control, margin));
    }
    ...
    {
        return Add(LayoutSlot.Weighted(component, weight, margin));
    }
    ...
    {
        return Add(LayoutSlot.Weighted(control, weight, margin));
    }
