...
/// </summary>
/// <remarks>
/// Effects are the runtime work counterpart to <see cref="TesseraApp.Update(Message)"/>. They are scheduled after
...
public delegate ValueTask<Message?> TesseraEffect(CancellationToken cancellationToken);
