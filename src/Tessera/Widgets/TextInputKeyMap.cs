...
internal sealed class TextInputKeyMap : IWidgetKeyMap
{
    ...
    public KeyBinding WordLeft { get; } =
        new("alt+left|alt+b", "word left", "alt+left", "ctrl+left", "alt+b", "meta+b");

    public KeyBinding WordRight { get; } =
        new("alt+right|alt+f", "word right", "alt+right", "ctrl+right", "alt+f", "meta+f");
    ...
    public KeyBinding DeleteWordBackward { get; } = new("alt+backspace|alt+h", "delete word left", "alt+backspace",
        "ctrl+backspace", "alt+h", "meta+h");

    public KeyBinding DeleteWordForward { get; } = new("alt+delete|alt+d", "delete word right", "alt+delete",
