...
/// </summary>
/// <remarks>
/// Use this type when you need more control than <see cref="RunAsync(TesseraApp, TesseraRuntimeOptions?, CancellationToken)"/>
...
public sealed class TesseraApplication
{
    ...
    private readonly TesseraRuntimeOptions _options;
    private readonly global::Tessera.Hosting.TesseraHostingOptions? _hosting;
    private readonly ITeaRuntime _runtime;

    internal TesseraApplication(TesseraApp app, TesseraRuntimeOptions? options = null, global::Tessera.Hosting.TesseraHostingOptions? hosting = null)
    {
        _app = app ?? throw new ArgumentNullException(nameof(app));
        _options = options ?? new TesseraRuntimeOptions();
        _hosting = hosting;
        _runtime = TesseraRuntimeFactory.Create(_app, _options, _hosting);
    }
    ...
    public static TesseraApplicationBuilder CreateBuilder() => new();
    ...
    public static async Task<TesseraApp> RunAsync(TesseraApp app, TesseraRuntimeOptions? options = null, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    public TesseraApp App => _app;

    /// <summary>
    /// Gets the runtime options applied to this application.
    /// </summary>
    public TesseraRuntimeOptions Options => _options;

    internal global::Tessera.Hosting.TesseraHostingOptions? HostingOptions => _hosting;
