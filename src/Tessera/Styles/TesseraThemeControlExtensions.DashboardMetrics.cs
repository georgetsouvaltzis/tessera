...
public static class TesseraThemeControlExtensionsDashboardMetricsDefaultExtensions
{
    ...
    public static BulletChart ApplyThemeDefaults(this BulletChart control, TesseraTheme theme)
    {
        ...
        control.WarningRangeStyle = TesseraThemeControlExtensions.ApplyDefault(control.WarningRangeStyle, theme.State.Warning);
        control.CriticalRangeStyle = TesseraThemeControlExtensions.ApplyDefault(control.CriticalRangeStyle, theme.State.Error);
        control.ValueBarStyle = TesseraThemeControlExtensions.ApplyDefault(control.ValueBarStyle, theme.Accent.Primary);
        control.TargetMarkerStyle = TesseraThemeControlExtensions.ApplyDefault(control.TargetMarkerStyle, theme.Focus.Ring);
        control.ValueLabelStyle = TesseraThemeControlExtensions.ApplyDefault(control.ValueLabelStyle, theme.Text.Secondary);
    ...
    public static DashboardGrid ApplyThemeDefaults(this DashboardGrid control, TesseraTheme theme)
    {
        ...
        control.SelectedTileStyleText = TesseraThemeControlExtensions.ApplyDefault(control.SelectedTileStyleText, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.HoveredTileStyleText = TesseraThemeControlExtensions.ApplyDefault(control.HoveredTileStyleText, theme.Accent.Secondary);
        control.DisabledTileStyleText = TesseraThemeControlExtensions.ApplyDefault(control.DisabledTileStyleText, theme.Text.Muted);
        control.FocusMarker = TesseraThemeControlExtensions.ApplyDefault(control.FocusMarker, theme.Focus.Marker);
        return control;
    }
    ...
    public static HealthBoard ApplyThemeDefaults(this HealthBoard control, TesseraTheme theme)
    {
        ...
        control.HealthyServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.HealthyServiceStyle, theme.State.Success);
        control.DegradedServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.DegradedServiceStyle, theme.State.Warning);
        control.OutageServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.OutageServiceStyle, theme.State.Error);
        control.HoveredServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.HoveredServiceStyle, theme.Accent.Secondary);
        control.SelectedServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedServiceStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedServiceStyle, theme.Focus.Ring);
        control.AcknowledgedServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.AcknowledgedServiceStyle, theme.Text.Muted);
        control.MutedServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.MutedServiceStyle, theme.Text.Muted);
        control.DisabledServiceStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledServiceStyle, theme.Text.Muted);
