...
public static class TesseraThemeControlExtensionsWorkspaceDefaultExtensions
{
    ...
    public static DockWorkspace ApplyThemeDefaults(this DockWorkspace control, TesseraTheme theme)
    {
        ...
        control.PaneTitleStyle = TesseraThemeControlExtensions.ApplyDefault(control.PaneTitleStyle, theme.Text.Secondary);
        control.SelectedPaneTitleStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedPaneTitleStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedPaneTitleStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedPaneTitleStyle, theme.Focus.Ring);
        control.PaneBodyStyle = TesseraThemeControlExtensions.ApplyDefault(control.PaneBodyStyle, theme.Text.Primary);
        control.SelectedPaneBodyStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedPaneBodyStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.HoveredPaneStyle = TesseraThemeControlExtensions.ApplyDefault(control.HoveredPaneStyle, theme.Accent.Secondary);
        control.MutedPaneStyle = TesseraThemeControlExtensions.ApplyDefault(control.MutedPaneStyle, theme.Text.Muted);
        control.DisabledPaneStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledPaneStyle, theme.Text.Muted);
        control.PaneBorderStyleText = TesseraThemeControlExtensions.ApplyDefault(control.PaneBorderStyleText, theme.Border.Default);
        control.FocusedPaneBorderStyleText = TesseraThemeControlExtensions.ApplyDefault(control.FocusedPaneBorderStyleText, theme.Border.Focused.Merge(theme.Focus.Border));
    ...
    public static PaneTabs ApplyThemeDefaults(this PaneTabs control, TesseraTheme theme)
    {
        ...
        control.SelectedTabStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedTabStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedTabStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedTabStyle, theme.Focus.Ring);
        control.HoveredTabStyle = TesseraThemeControlExtensions.ApplyDefault(control.HoveredTabStyle, theme.Accent.Secondary);
        control.DisabledTabStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledTabStyle, theme.Text.Muted);
    ...
    public static Heatmap ApplyThemeDefaults(this Heatmap control, TesseraTheme theme)
    {
        ...
        control.HoveredCellStyle = TesseraThemeControlExtensions.ApplyDefault(control.HoveredCellStyle, theme.Accent.Secondary);
        control.SelectedCellStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedCellStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedCellStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedCellStyle, theme.Focus.Ring);
        control.DisabledCellStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledCellStyle, theme.Text.Muted);
    ...
    public static TreeMapChart ApplyThemeDefaults(this TreeMapChart control, TesseraTheme theme)
    {
        ...
        control.HoveredNodeStyle = TesseraThemeControlExtensions.ApplyDefault(control.HoveredNodeStyle, theme.Accent.Secondary);
        control.SelectedNodeStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedNodeStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedNodeStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedNodeStyle, theme.Focus.Ring);
        control.DisabledNodeStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledNodeStyle, theme.Text.Muted);
    ...
    public static PaletteEditor ApplyThemeDefaults(this PaletteEditor control, TesseraTheme theme)
    {
        ...
        control.HoveredSwatchStyle = TesseraThemeControlExtensions.ApplyDefault(control.HoveredSwatchStyle, theme.Accent.Secondary);
        control.SelectedSwatchStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedSwatchStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedSwatchStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedSwatchStyle, theme.Focus.Ring);
        control.MutedSwatchStyle = TesseraThemeControlExtensions.ApplyDefault(control.MutedSwatchStyle, theme.Text.Muted);
        control.PreviewSwatchStyle = TesseraThemeControlExtensions.ApplyDefault(control.PreviewSwatchStyle, theme.Accent.Primary);
        control.DisabledSwatchStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledSwatchStyle, theme.Text.Muted);
        control.EmptyTextStyle = TesseraThemeControlExtensions.ApplyDefault(control.EmptyTextStyle, theme.Text.Muted);
        control.FocusMarker = TesseraThemeControlExtensions.ApplyDefault(control.FocusMarker, theme.Focus.Marker);
        return control;
    }
    ...
    public static TerminalPanel ApplyThemeDefaults(this TerminalPanel control, TesseraTheme theme)
    {
        ...
        control.StandardOutputStyle = TesseraThemeControlExtensions.ApplyDefault(control.StandardOutputStyle, theme.Text.Primary);
        control.StandardErrorStyle = TesseraThemeControlExtensions.ApplyDefault(control.StandardErrorStyle, theme.State.Error);
        ...
        control.SelectedLineStyle = TesseraThemeControlExtensions.ApplyDefault(control.SelectedLineStyle, theme.Selection.Foreground.Merge(theme.Selection.Background));
