...
public static class TesseraThemeControlExtensionsPlottingDefaultExtensions
{
    ...
    public static BoxPlot ApplyThemeDefaults(this BoxPlot control, TesseraTheme theme)
    {
        ...
        control.HoveredSeriesStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.HoveredSeriesStyle, theme.Accent.Secondary);
        control.SelectedSeriesStyle = TesseraThemeControlExtensions.ApplyDefault(
            control.SelectedSeriesStyle,
            theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedSelectedSeriesStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.FocusedSelectedSeriesStyle, theme.Focus.Ring);
        ...
        control.MutedSeriesStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.MutedSeriesStyle, theme.Text.Muted);
        control.DisabledSeriesStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.DisabledSeriesStyle, theme.Text.Muted);
