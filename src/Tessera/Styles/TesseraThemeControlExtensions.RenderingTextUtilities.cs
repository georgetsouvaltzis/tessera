...
public static class TesseraThemeControlExtensionsRenderingTextUtilitiesDefaultExtensions
{
    ...
    public static Badge ApplyThemeDefaults(this Badge control, TesseraTheme theme)
    {
        ...
        control.FocusedTextStyle = TesseraThemeControlExtensions.ApplyDefault(control.FocusedTextStyle, theme.Focus.Ring);
        control.SuccessTextStyle = TesseraThemeControlExtensions.ApplyDefault(control.SuccessTextStyle, theme.State.Success);
        control.WarningTextStyle = TesseraThemeControlExtensions.ApplyDefault(control.WarningTextStyle, theme.State.Warning);
    ...
    public static LogView ApplyThemeDefaults(this LogView control, TesseraTheme theme)
    {
        ...
        control.PausedTitleStyle = TesseraThemeControlExtensions.ApplyDefault(control.PausedTitleStyle, theme.Text.Muted);
