...
public static class TesseraThemeOverrideBundleDashboardExtensions
{
    ...
    public static ListView<T> ApplyDashboardOverrides<T>(this ListView<T> control, TesseraThemeOverrideBundle bundle)
    {
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static Table ApplyDashboardOverrides(this Table control, TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static Notifications ApplyDashboardOverrides(this Notifications control, TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static LogView ApplyDashboardOverrides(this LogView control, TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static Button ApplyDashboardOverrides(this Button control, TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static Dialog ApplyDashboardOverrides(this Dialog control, TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
...
public static class TesseraThemeOverrideBundleThemeAndDashboardExtensions
{
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static ListView<T> ApplyThemeAndDashboardOverrides<T>(this ListView<T> control,
        TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static Notifications ApplyThemeAndDashboardOverrides(this Notifications control,
        TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
    ...
    /// <param name="bundle">The override bundle to apply.</param>
    /// <returns>The same <paramref name="control" /> instance.</returns>
    public static Dialog ApplyThemeAndDashboardOverrides(this Dialog control, TesseraThemeOverrideBundle bundle)
    {
        ArgumentNullException.ThrowIfNull(control);
        ArgumentNullException.ThrowIfNull(bundle);
