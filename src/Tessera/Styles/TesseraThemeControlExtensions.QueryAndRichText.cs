...
public static class TesseraThemeControlExtensionsQueryAndRichTextDefaultExtensions
{
    ...
    public static PivotTable ApplyThemeDefaults(this PivotTable control, TesseraTheme theme)
    {
        ...
        control.FocusedCellStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.FocusedCellStyle, theme.Focus.Ring);
    ...
    /// <summary>
    ///     Resolves and applies hierarchical defaults to a <see cref="PivotTable" /> without overwriting explicit non-empty
    ///     styles.
    /// </summary>
    ...
    public static QueryBuilder ApplyThemeDefaults(this QueryBuilder control, TesseraTheme theme)
    {
        ...
        control.SelectedRuleStyle = TesseraThemeControlExtensions.ApplyDefault(
            ...
            theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.FocusedRuleStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.FocusedRuleStyle, theme.Focus.Ring);
        control.HoveredRuleStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.HoveredRuleStyle, theme.Accent.Secondary);
        control.DisabledRuleStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.DisabledRuleStyle, theme.Text.Muted);
    ...
    /// <summary>
    ///     Resolves and applies hierarchical defaults to a <see cref="QueryBuilder" /> without overwriting explicit non-empty
    ///     styles.
    /// </summary>
    ...
    public static RichTextView ApplyThemeDefaults(this RichTextView control, TesseraTheme theme)
    {
        ...
        control.ListMarkerStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.ListMarkerStyle, theme.Text.Secondary);
        control.QuoteMarkerStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.QuoteMarkerStyle, theme.Text.Muted);
        control.EmphasisStyle =
            TesseraThemeControlExtensions.ApplyDefault(control.EmphasisStyle, theme.Accent.Secondary);
        control.StrongStyle = TesseraThemeControlExtensions.ApplyDefault(control.StrongStyle, theme.Accent.Primary);
        control.InlineCodeStyle = TesseraThemeControlExtensions.ApplyDefault(control.InlineCodeStyle,
            theme.Surface.Panel.Merge(theme.Text.Primary));
        control.DisabledStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledStyle, theme.Text.Muted);
        control.BorderStyleText =
            TesseraThemeControlExtensions.ApplyDefault(control.BorderStyleText, theme.Border.Default);
        control.FocusedBorderStyleText = TesseraThemeControlExtensions.ApplyDefault(control.FocusedBorderStyleText,
    ...
    /// <summary>
    ///     Resolves and applies hierarchical defaults to a <see cref="RichTextView" /> without overwriting explicit non-empty
    ///     styles.
    /// </summary>
