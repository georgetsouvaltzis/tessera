...
public static class TesseraThemeControlExtensionsNavigationPrimitivesDefaultExtensions
{
    ...
    public static Accordion ApplyThemeDefaults(this Accordion control, TesseraTheme theme)
    {
        ...
        control.ExpandedItemStyle = TesseraThemeControlExtensions.ApplyDefault(control.ExpandedItemStyle, theme.Accent.Secondary);
    ...
    public static MultiSelect ApplyThemeDefaults(this MultiSelect control, TesseraTheme theme)
    {
        ...
        control.SelectedItemStyle = TesseraThemeControlExtensions.ApplyDefault(
            control.SelectedItemStyle,
            theme.Selection.Foreground.Merge(theme.Selection.Background));
        control.CheckedItemStyle = TesseraThemeControlExtensions.ApplyDefault(control.CheckedItemStyle, theme.Accent.Primary);
        control.DisabledItemStyle = TesseraThemeControlExtensions.ApplyDefault(control.DisabledItemStyle, theme.Text.Muted);
        return control;
    }
