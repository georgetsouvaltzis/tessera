...
public sealed class DockWorkspace : Control
{
    ...
    public TeaStyle PaneTitleStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets selected pane title style.</summary>
    public TeaStyle SelectedPaneTitleStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets focused selected pane title style.</summary>
    public TeaStyle FocusedSelectedPaneTitleStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets pane body style.</summary>
    public TeaStyle PaneBodyStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets selected pane body style.</summary>
    public TeaStyle SelectedPaneBodyStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets hovered pane style.</summary>
    public TeaStyle HoveredPaneStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets muted pane style.</summary>
    public TeaStyle MutedPaneStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets disabled pane style.</summary>
    public TeaStyle DisabledPaneStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets pane border style while unselected.</summary>
    public TeaStyle PaneBorderStyleText { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets pane border style while selected and focused.</summary>
    public TeaStyle FocusedPaneBorderStyleText { get; set; } = TeaStyle.Empty;
    ...
    public void SetPanes(IEnumerable<DockPane> panes)
    {
        ...
        {
            if (pane is not null) _panes.Add(ClonePane(pane));
        }
    ...
    private TeaStyle ResolveOuterBorderStyle()
    {
    ...
    private TeaStyle ResolvePaneBorderStyle(int index, DockPane pane)
    {
