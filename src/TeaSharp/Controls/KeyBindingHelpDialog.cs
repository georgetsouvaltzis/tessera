...
public sealed class KeyBindingHelpDialog : Control
{
    ...
    public TeaStyle KeysStyle { get; set; } = TeaStyle.Empty;
    ...
    public TeaStyle GlobalBindingStyle { get; set; } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveRowStyle(KeyBindingItem item, bool selected, bool hovered)
    {
