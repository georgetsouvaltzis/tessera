...
public sealed class Paginator : Control
{
    ...
    /// </summary>
    public TeaStyle ActivePageLabelStyle
    {
        get;
        set;
    } = TeaStyle.Empty;
    ...
    /// </summary>
    public TeaStyle DisabledNavigationLabelStyle
    {
        get;
        set;
    } = TeaStyle.Empty;
    ...
    private static void WriteSegment(Canvas canvas, int x, int y, string text, TeaStyle style, int right)
    {
