...
public sealed partial class LogTailPanel
{
    ...
    private TeaStyle ResolveEntryStyle(int index, LogEntry? entry)
    {
    ...
    private void WriteStyledLine(Canvas canvas, int x, int y, int width, string line, TeaStyle style)
    {
