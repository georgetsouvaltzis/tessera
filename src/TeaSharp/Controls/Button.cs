...
public sealed class Button : Control
{
    ...
    /// </summary>
    public TeaStyle FocusedLabelStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets the style merged into the label style when the button is disabled.
    /// Background-like facets are ignored so the button body remains a single surface.
    /// </summary>
    public TeaStyle DisabledLabelStyle { get; set; } = TeaStyle.Empty;
    ...
    private static void FillSurface(Canvas canvas, Rect box, TeaStyle surfaceStyle)
    {
