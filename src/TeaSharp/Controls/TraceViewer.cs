...
public sealed partial class TraceViewer : Control
{
    ...
    /// </summary>
    public TeaStyle VerboseRowStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets informational row style.
    /// </summary>
    public TeaStyle InfoRowStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets warning row style.
    /// </summary>
    public TeaStyle WarningRowStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets error row style.
    /// </summary>
    public TeaStyle ErrorRowStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets critical row style.
    /// </summary>
    public TeaStyle CriticalRowStyle { get; set; } = TeaStyle.Empty;
    ...
    internal override LayoutMeasurement Measure(in Rect availableBounds)
    {
        ...
        {
            var rowWidth = ControlTextLayout.MeasureDisplayWidth(FormatLine(_entries[index], selected: false));
