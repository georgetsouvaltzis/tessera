...
public sealed class Form : Control
{
    ...
    public TeaStyle RequiredMarkerStyle { get; set; } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveRowStyle(int index, bool fieldDisabled)
    {
    ...
    private TeaStyle ResolveRequiredStyle(bool selected, bool fieldDisabled)
    {
