...
public sealed partial class AutocompleteInput : Control
{
    ...
    /// </summary>
    public TeaStyle InputTextStyle { get; set; } = TeaStyle.Empty;
    ...
    /// </summary>
    public TeaStyle PopupStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets style used for non-selected suggestions.
    /// </summary>
    public TeaStyle SuggestionStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets style merged for hovered suggestions.
    /// </summary>
    public TeaStyle HoveredSuggestionStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets style merged for selected suggestions.
    /// </summary>
    public TeaStyle SelectedSuggestionStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets style merged for selected suggestions while focused.
    /// </summary>
    public TeaStyle FocusedSelectedSuggestionStyle { get; set; } = TeaStyle.Empty;
    ...
    /// </summary>
    public TeaStyle CommitMarkerStyle { get; set; } = TeaStyle.Empty;
