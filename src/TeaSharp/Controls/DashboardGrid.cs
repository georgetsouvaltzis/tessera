...
public sealed partial class DashboardGrid : Control
{
    ...
    /// </summary>
    public TeaStyle TileStyleText { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged into selected tile text.
    /// </summary>
    public TeaStyle SelectedTileStyleText { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged into hovered tile text.
    /// </summary>
    public TeaStyle HoveredTileStyleText { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged when the control is disabled.
    /// </summary>
    public TeaStyle DisabledTileStyleText { get; set; } = TeaStyle.Empty;
