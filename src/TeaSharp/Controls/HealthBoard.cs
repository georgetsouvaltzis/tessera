...
public sealed partial class HealthBoard : Control
{
    ...
    /// </summary>
    public TeaStyle ServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for healthy rows.
    /// </summary>
    public TeaStyle HealthyServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for degraded rows.
    /// </summary>
    public TeaStyle DegradedServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for outage rows.
    /// </summary>
    public TeaStyle OutageServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for hovered rows.
    /// </summary>
    public TeaStyle HoveredServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for selected rows.
    /// </summary>
    public TeaStyle SelectedServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for selected rows while focused.
    /// </summary>
    public TeaStyle FocusedSelectedServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for acknowledged rows.
    /// </summary>
    public TeaStyle AcknowledgedServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged for muted rows.
    /// </summary>
    public TeaStyle MutedServiceStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged while disabled.
    /// </summary>
    public TeaStyle DisabledServiceStyle { get; set; } = TeaStyle.Empty;
