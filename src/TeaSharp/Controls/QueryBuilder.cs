...
public sealed class QueryBuilder : Control
{
    ...
    /// </summary>
    public TeaStyle RuleStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged into selected rules.
    /// </summary>
    public TeaStyle SelectedRuleStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged into selected rules while focused.
    /// </summary>
    public TeaStyle FocusedRuleStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged into hovered rules.
    /// </summary>
    public TeaStyle HoveredRuleStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged when disabled.
    /// </summary>
    public TeaStyle DisabledRuleStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style merged when error state is active.
    /// </summary>
    public TeaStyle ErrorRuleStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets preview-row style.
    /// </summary>
    public TeaStyle PreviewStyle { get; set; } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveRuleStyle(int index, int hoveredIndex, QueryRule? rule)
    {
        var style = RuleStyle;
    ...
    private TeaStyle ResolvePreviewStyle()
    {
