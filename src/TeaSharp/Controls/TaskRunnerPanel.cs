...
public sealed class TaskRunnerPanel : Control
{
    ...
    public TeaStyle StatusMarkerStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for running marker state.</summary>
    public TeaStyle RunningStatusStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for succeeded marker state.</summary>
    public TeaStyle SucceededStatusStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for failed marker state.</summary>
    public TeaStyle FailedStatusStyle { get; set; } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveMarkerStyle(int index, TaskRunStatus status)
    {
    ...
    private TeaStyle ResolveStatusStyle(TaskRunStatus status)
    {
