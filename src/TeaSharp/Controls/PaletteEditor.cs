...
public sealed class PaletteEditor : Control
{
    ...
    public TeaStyle SwatchStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets hovered row style.</summary>
    public TeaStyle HoveredSwatchStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets selected row style.</summary>
    public TeaStyle SelectedSwatchStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets focused selected row style.</summary>
    public TeaStyle FocusedSelectedSwatchStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets muted row style.</summary>
    public TeaStyle MutedSwatchStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets preview glyph style.</summary>
    public TeaStyle PreviewSwatchStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets disabled row style.</summary>
    public TeaStyle DisabledSwatchStyle { get; set; } = TeaStyle.Empty;
    ...
    public void SetSwatches(IEnumerable<PaletteSwatch> swatches)
    {
        ...
        {
            if (swatch is not null) _swatches.Add(CloneSwatch(swatch));
        }
    ...
    private TeaStyle ResolveEmptyStyle() => IsDisabled ? EmptyTextStyle.Merge(DisabledSwatchStyle) : EmptyTextStyle;
    private TeaStyle ResolvePreviewStyle(PaletteSwatch swatch) => PreviewSwatchStyle.Merge(swatch.PreviewStyle);

    private TeaStyle ResolveSwatchStyle(int index, PaletteSwatch swatch)
    {
    ...
    private static int WriteStyledText(Canvas canvas, int x, int y, string text, TeaStyle style, int width)
    {
