...
public sealed class DiffView : Control
{
    ...
    /// </summary>
    public TeaStyle AddedLineStyle
    {
        get;
        set;
    } = TeaStyle.Empty;
    ...
    /// </summary>
    public TeaStyle RemovedLineStyle
    {
        get;
        set;
    } = TeaStyle.Empty;
    ...
    /// </summary>
    public TeaStyle UnchangedLineStyle
    {
        get;
        set;
    } = TeaStyle.Empty;
    ...
    /// </summary>
    public TeaStyle SelectedLineStyle
    {
        get;
        set;
    } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveEntryStyle(DiffLineKind kind, bool selected)
    {
