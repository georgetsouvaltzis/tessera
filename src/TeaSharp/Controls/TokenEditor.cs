...
public sealed partial class TokenEditor : Control
{
    ...
    /// </summary>
    public TeaStyle TokenStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Style merged into selected token chips.
    /// </summary>
    public TeaStyle SelectedTokenStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Style merged into selected token chips while focused.
    /// </summary>
    public TeaStyle FocusedSelectedTokenStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Style merged into hovered token chips.
    /// </summary>
    public TeaStyle HoveredTokenStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Style merged into disabled chips and disabled control state.
    /// </summary>
    public TeaStyle DisabledTokenStyle { get; set; } = TeaStyle.Empty;
