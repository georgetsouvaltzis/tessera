...
public sealed class Heatmap : Control
{
    ...
    public TeaStyle CellStyle { get; set; } = TeaStyle.Empty;
    ...
    public TeaStyle FocusedSelectedCellStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style merged while control is disabled.</summary>
    public TeaStyle DisabledCellStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for low-intensity cells.</summary>
    public TeaStyle LowCellStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for medium-intensity cells.</summary>
    public TeaStyle MidCellStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for high-intensity cells.</summary>
    public TeaStyle HighCellStyle { get; set; } = TeaStyle.Empty;
    /// <summary>Gets or sets style for peak-intensity cells.</summary>
    public TeaStyle PeakCellStyle { get; set; } = TeaStyle.Empty;
    ...
    private void LegendBand(Canvas canvas, ref int x, int y, int width, char glyph, string label, TeaStyle style)
    {
    ...
    private TeaStyle StateStyle(int row, int column)
    {
    ...
    private TeaStyle ResolveStyle(TeaStyle style) => IsDisabled ? style.Merge(DisabledCellStyle) : style;
    ...
    private static string StyleText(string text, TeaStyle style) => style.IsEmpty ? text : style.Render(text);
    private static void Write(Canvas canvas, int x, int y, string text, TeaStyle style, int width) => canvas.WriteText(x, y, StyleText(text, style), width);
