...
public sealed class RichTextView : Control
{
    ...
    /// </summary>
    public TeaStyle HeadingStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style used for list markers.
    /// </summary>
    public TeaStyle ListMarkerStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style used for quote markers.
    /// </summary>
    public TeaStyle QuoteMarkerStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style used for inline emphasis.
    /// </summary>
    public TeaStyle EmphasisStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style used for inline strong emphasis.
    /// </summary>
    public TeaStyle StrongStyle { get; set; } = TeaStyle.Empty;

    /// <summary>
    /// Gets or sets style used for inline code text.
    /// </summary>
    public TeaStyle InlineCodeStyle { get; set; } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveTextStyle(RichTextStyleKind styleKind)
    {
        var style = TextStyle;
