...
public sealed class SearchBox : Control
{
    ...
    public TeaStyle MatchCounterStyle { get; set; } = TeaStyle.Empty;

    /// <summary>Gets or sets style merged when matches are available.</summary>
    public TeaStyle MatchHighlightStyle { get; set; } = TeaStyle.Empty;

    /// <summary>Gets or sets style for previous/next labels.</summary>
    public TeaStyle NavigationLabelStyle { get; set; } = TeaStyle.Empty;

    /// <summary>Gets or sets style merged into disabled previous/next labels.</summary>
    public TeaStyle DisabledNavigationLabelStyle { get; set; } = TeaStyle.Empty;
    ...
    private TeaStyle ResolveMatchStyle()
    {
    ...
    private TeaStyle ResolveNavigationStyle(bool enabled)
    {
