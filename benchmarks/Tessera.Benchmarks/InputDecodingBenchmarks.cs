...
public class InputDecodingBenchmarks
{
    ...
    {
        var result = _decoder.Decode(OscClipboardSequence, false);
    ...
    {
        var result = _decoder.Decode(OscColorSequence, false);
        return result.Consumed;
    }
    ...
    {
        var result = _decoder.Decode(DcsCapabilitySequence, false);
        return result.Consumed;
    }
}
