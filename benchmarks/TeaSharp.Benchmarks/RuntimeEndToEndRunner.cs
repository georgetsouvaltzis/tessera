...
internal static class RuntimeEndToEndRunner
{
    ...
    private static RuntimeEndToEndResult Execute()
    {
        ...
        {
            Schema = "teasharp-runtime-e2e-result-v1",
            Status = "measured",
    ...
    private static RuntimeEndToEndIterationResult RunIteration()
    {
        ...
        try
        {
            ...
            var hosting = new TeaHostingOptions
            {
            ...
            var application = TeaHost.CreateApplication(app, options, hosting);
            stopwatch.Start();
    ...
    private sealed class RuntimeEndToEndProbeApp(int targetInputs) : TeaApp
    {
